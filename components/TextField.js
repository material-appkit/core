...
var TextField = function (_React$PureComponent) {
  ...
  function TextField() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TextField.__proto__ || Object.getPrototypeOf(TextField)).call.apply(_ref, [this].concat(args))), _this), _this.delayedChangeTimer = null, _this.handleTextFieldChange = function (e) {
  ...
  _createClass(TextField, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ['onChange', 'onTimeout', 'timeoutDelay']);

      return _react2.default.createElement(_TextField2.default, _extends({ onChange: this.handleTextFieldChange }, rest));
    }
  }]);
